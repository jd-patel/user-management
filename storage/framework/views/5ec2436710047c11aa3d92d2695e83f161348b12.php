<?php $__env->startSection("htmlheader_title", "Dashboard"); ?>
			...
			<div class="info-box">
			  ...
			  <div class="info-box-content">
				...
				<span class="info-box-number">
				  <?php echo e($userStatistics['totalUsers']); ?>
		  ...
		  <div class="col-12 col-sm-6 col-md-3">
			<div class="info-box mb-3">
			  ...
			  <div class="info-box-content">
				...
				<span class="info-box-number"><?php echo e($userStatistics['activeUsers']); ?></span>
			  </div>
			  <!-- /.info-box-content -->
			</div>
			<!-- /.info-box -->
		  ...
		  <div class="col-12 col-sm-6 col-md-3">
			<div class="info-box mb-3">
			  ...
			  <div class="info-box-content">
				...
				<span class="info-box-number"><?php echo e($userStatistics['genderMale']); ?></span>
			  </div>
			  <!-- /.info-box-content -->
			</div>
			<!-- /.info-box -->
		  ...
		  <div class="col-12 col-sm-6 col-md-3">
			<div class="info-box mb-3">
			  ...
			  <div class="info-box-content">
				...
				<span class="info-box-number"><?php echo e($userStatistics['genderFemale']); ?></span>
			  </div>
			  <!-- /.info-box-content -->
			</div>
			<!-- /.info-box -->
			  ...
			  <div class="card-body" style="min-height: 390px;">
				<table id="users-list" class="table table-bordered table-hover">
				  ...
				  <?php if( !$recentUsers->isEmpty() ): ?>
					  ...
					  <?php $__currentLoopData = $recentUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					  <tr>
...
<script type="text/javascript">
  $(function () {
	...
	var areaChartData = {
	  labels  : <?php echo $monthWiseCount["months"]; ?>,
	  datasets: [
		{
		  label               : 'User Count',
		  backgroundColor     : 'rgb(75, 192, 192,0.9)',
		  borderColor         : 'rgb(75, 192, 192,0.8)',
		  data                : <?php echo $monthWiseCount['counts']; ?>,
		  fill: false,
		},
	  ]
	}
	...
	var labels = <?php echo $genderWiseCount['gender']; ?>;
	...
	var donutData        = {
	  ...
	  datasets: [
		{
		  // label: labels,
		  data: <?php echo $genderWiseCount['counts']; ?>,
	...
	// Gender Wise Chart Start
	// Get context with jQuery - using jQuery's .get() method.
	var labels = <?php echo $ageWiseCount['ageRange']; ?>;
	var backgroundColors=[];
	var borderColors=[];
	...
	var donutData        = {
	  ...
	  datasets: [
		{
		  // label: labels,
		  data: <?php echo $ageWiseCount['counts']; ?>,
	...
	// Get context with jQuery - using jQuery's .get() method.
	var labels = <?php echo $socialProviderWise['loginType']; ?>;
	var backgroundColors=[];
	...
	var donutData        = {
	  ...
	  datasets: [
		{
		  data: <?php echo $socialProviderWise['counts']; ?>,
		  backgroundColor : backgroundColors,
		  borderWidth: 1
		}
	  ]
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/demo/user-management/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>